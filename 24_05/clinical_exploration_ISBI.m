...
%%
iRoi= 1;
% imagesc(dataRoi{iRoi}.x,dataRoi{iRoi}.z,dataRoi{iRoi}.TV)
figure, 
tiledlayout(1,2)
nexttile,
imagesc(dataRoi{iRoi}.TV)
iz = 4; ix = 8;
sldLine = squeeze(b(iz,ix,:))*NptodB;
...
% fit1 = f\sldLine;
fit1 = [dataRoi{iRoi}.TV(iz,ix) dataRoi{iRoi}.TVC(iz,ix) ];
...
figure('Units','centimeters', 'Position',[5 5 20 4.5])
